...
export const DEFAULT_EMPTY = {
	title: "No Data Found",
	message:
		"Looks like the database is taking a nap. Wake it up with some new enteries.",
	button: {
		text: "Add Data",
		href: ROUTES.HOME,
	},
...
export const EMPTY_ANSWERS = {
	...
	message:
		"The answer section is empty. Be the first to share your knowledge and help others.",
	// button: {
	// 	text: "Answer",
	// 	href: ROUTES.HOME,
	// },
